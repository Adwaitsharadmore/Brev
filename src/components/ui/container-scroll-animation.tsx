...
export const ContainerScroll = ({
  ...
  return (
    ...
    >
      <div
        className="pt-5 w-full relative md:px-0 px-10"
        style={{
          perspective: "1200px",
        }}
      >
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-3xl -mt-12 mx-auto h-[11rem] md:h-[28rem] w-full border-4 border-[#6C6C6C] p-4 md:p-6 bg-[#222222] rounded-[30px] shadow-2xl"
    >
